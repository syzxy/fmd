/**
 * Copied from https://github.com/Doist/typist/blob/main/src/extensions/rich-text/rich-text-link.ts
 * Discussion: https://github.com/ueberdosis/tiptap/discussions/1865
 */
...
export type { LinkOptions as MdLinkOptions };
